...
pat_df_manual_version = 'data_split/pat_df_medstream_manual_H_dp_img_of_' \
                        'int_2_summary_cols_pat_sets_stratmean_split699_2019-05-03_18-40-24.csv'
short_medstream_version = 'data_split/pat_df_medstream_H_dp_img_of_' \
                          'int_2_summary_cols_pat_sets_stratmean_split699_2019-05-03_18-40-20.csv'
...
total_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'train', 'r_total_one_hand'],
              bins=nbin, label='train',
              density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
total_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'val', 'r_total_one_hand'],
              bins=nbin, alpha=0.7, label='val',
              density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
total_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'test', 'r_total_one_hand'],
...
jsn_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'train', 'r_total_one_hand_JSN'],
            bins=nbin, label='train',
            density=True, cumulative=cumulative_flag, histtype=histtype)
jsn_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'val', 'r_total_one_hand_JSN'],
            bins=nbin, alpha=0.7, label='val',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
jsn_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'test', 'r_total_one_hand_JSN'],
            bins=nbin, alpha=0.5, label='test',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
...
ero_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'train', 'r_total_one_hand_ero'],
            bins=nbin, label='train',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
ero_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'val', 'r_total_one_hand_ero'],
            bins=nbin, alpha=0.7, label='val',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
ero_ax.hist(short_medstream_R_L_manual.loc[short_medstream_R_L_manual.segm_set == 'test', 'r_total_one_hand_ero'],
            bins=nbin, alpha=0.5, label='test',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
...
total_ax.set_title('r_total_one_hand')
total_ax.hist(chosen_df.loc[chosen_df.segm_set == 'train', 'r_total_one_hand'],
              bins=nbin, label='train',
              density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
total_ax.hist(chosen_df.loc[chosen_df.segm_set == 'val', 'r_total_one_hand'],
              bins=nbin, alpha=0.7, label='val',
              density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
total_ax.hist(chosen_df.loc[chosen_df.segm_set == 'test', 'r_total_one_hand'],
              bins=nbin, alpha=0.5, label='test',
              density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
# total_ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05), shadow=True, ncol=3)
...
jsn_ax.set_title('r_total_one_hand_JSN')
jsn_ax.hist(chosen_df.loc[chosen_df.segm_set == 'train', 'r_total_one_hand_JSN'],
            bins=nbin, label='train',
            density=True, cumulative=cumulative_flag, histtype=histtype)
jsn_ax.hist(chosen_df.loc[chosen_df.segm_set == 'val', 'r_total_one_hand_JSN'],
            bins=nbin, alpha=0.7, label='val',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
jsn_ax.hist(chosen_df.loc[chosen_df.segm_set == 'test', 'r_total_one_hand_JSN'],
            bins=nbin, alpha=0.5, label='test',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
jsn_ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05), shadow=True, ncol=3)
...
ero_ax.set_title('r_total_one_hand_ero')
ero_ax.hist(chosen_df.loc[chosen_df.segm_set == 'train', 'r_total_one_hand_ero'],
            bins=nbin, label='train',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
ero_ax.hist(chosen_df.loc[chosen_df.segm_set == 'val', 'r_total_one_hand_ero'],
            bins=nbin, alpha=0.7, label='val',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
ero_ax.hist(chosen_df.loc[chosen_df.segm_set == 'test', 'r_total_one_hand_ero'],
            bins=nbin, alpha=0.5, label='test',
            density=normed_flag, cumulative=cumulative_flag, histtype=histtype)
# ero_ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05), shadow=True, ncol=3)
...
short_medstream_filename = output_folder + os.sep + 'data_split' + os.sep + \
                           "pat_df_medstream_H_dp_img_of_int_2_summary_cols_pat_segm_sets_strat" + \
