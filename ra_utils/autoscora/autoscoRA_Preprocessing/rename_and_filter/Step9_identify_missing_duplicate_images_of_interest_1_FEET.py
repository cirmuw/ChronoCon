...
pat_df_manual_version = "pat_df_img_of_interest_FEET/pat_df_manual_2021-05-06_16-15-24_Step8_2021-05-17_11-02-11.csv"
...
candidate_dir = re.sub(os.path.split(dicom_server)[1] + "$", "F_dp_missing_candidate_1_dicoms", dicom_server)
...
with open(output_folder + os.sep + 'pat_df_img_of_interest_FEET/missing_paths.txt', mode='wt', encoding='utf-8') as myfile:
    myfile.write('\n'.join(list(list_of_candidates_paths)))
# cd /Volumes/Research/Diplomarbeiten/Diplomand_innen_Thomas_Deimel/Kanta_Chrysa/spreadsheets/pat_df_img_of_interest_FEET
# cat missing_paths.txt | head -200 | xargs -J % cp % /project/autoscora/autoscoRA_images/F_dp_missing_candidate_1_dicoms
