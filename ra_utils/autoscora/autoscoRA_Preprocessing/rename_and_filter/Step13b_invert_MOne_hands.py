...
for file_i in filepaths:
    ...
    if xray.img.PhotometricInterpretation == 'MONOCHROME1':
        ...
        pass
print("No. of MOne hands: " + str(len(MOne_hands)))

print("Checking that it worked")
MOne_to_MTwo_list = []
for file_j in MOne_hands:
    xray = XRay(file_j)
...
print("All files in MOne_hands are now MTwo:", all_MOne_to_MTwo)
