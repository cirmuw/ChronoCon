...
for file_i in filepaths:
    ...
    if xray.img.PhotometricInterpretation == 'MONOCHROME1':
        ...
        pass
print("No. of MOne feet: " + str(len(MOne_feet)))

print("Checking that it worked")
MOne_to_MTwo_list = []
for file_j in MOne_feet:
    xray = XRay(file_j)
    MOne_to_MTwo_list = MOne_to_MTwo_list + [xray.img.PhotometricInterpretation]

all_MOne_to_MTwo = all([i == 'MONOCHROME2' for i in MOne_to_MTwo_list])
print("All files in MOne_feet are now MTwo:", all_MOne_to_MTwo)
