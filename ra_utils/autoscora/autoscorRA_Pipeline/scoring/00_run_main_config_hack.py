...
from ra_utils.autoscora.autoscorRA_Pipeline.scoring.src.run_utils import paths_list_scores_list_from_score_types
...
params = {}
params["vgg_type"] = "vgg19_bn" # params["all_vgg_types"][6]


# TODO: remove this old parser... Should be done in the config file
### Read Parameters ###
...
def add_args_to_params(params, args):
    ...
    if args.bin:
        params["binary"] = args.bin  # 0 ... all classes / 1 ... [0] vs. rest / 2 ... [0,1] vs. rest
    else: 
        params["binary"] = 0
    if args.val:
        val = args.val
...
add_args_to_params(params, args)
...
path_list, score_list = paths_list_scores_list_from_score_types(chosen_score = params["chosen_score"],
...
train_indices, val_indices, test_indices, score_list, path_list = get_indices4(train_test_split = params["train_test_split"],
                                                                                ...
                                                                                path_to_model_dir=params["path_to_model"])
...
def log_params_txt(file_path, params):
...
file_path = params["path_to_model"] + "logfile.txt"
log_params_txt(file_path, params)
