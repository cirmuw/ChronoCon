...
# import ra_utils.mtan.im2im_pred.model_resnet_mtan.resnet as resnet_BUGGY
...
class MTANReconv3(nn.Module):
    def __init__(self, 
                 ...
                 return_also_recon_latent=False, 
                 latent_dim=None):
        super(MTANReconv3, self).__init__()
        encoder_name = resnet_infos[backbone_name]["encoder_name"]
...
class MTANReconv4(nn.Module):
    def __init__(self, 
                 ...
                 return_also_recon_latent=False, 
                 latent_dim=None):
        super(MTANReconv4, self).__init__()
        encoder_name = resnet_infos[backbone_name]["encoder_name"]
