...
def train_epoch(
        ...
        for i in range(len(timepoints)):
            for j in range(len(timepoints)):
                if i != j: 
                    ...
                    cov_loss = compute_cross_cov_loss((maps1, maps2, maps3))
                    ...
                    if mode == 'all':
                        loss = loss_rec + loss_temp + cov_loss + loss_sup
                    if mode == 'sup':
                    ...
                    loss_cov_epoch.append(cov_loss.item())
    ...
    return {
        ...
        'cov' : sum(loss_cov_epoch)/len(loss_cov_epoch)
    }
