...
#  Data-loader factory
# ---------------------------------------------------------------------
import ra_utils.data.datasampler_CR_patches
...
def prepare_dataloaders(datasets, config):
    ...
    if sampler_name == "WeightedRandomSampler":
        ...
        batch_sampler = ra_utils.data.datasampler_CR_patches.GroupLevelWeightedBatchSampler(
        ...
        batch_sampler = ra_utils.data.datasampler_CR_patches.GroupLevelTypePriorBatchSampler(
            dataset=datasets["dataset_train"],
            batch_size=batch_size,
            group_identifiers=group_identifiers,
            target_col=target_col,
        ...
        batch_sampler = ra_utils.data.datasampler_CR_patches.GroupedWeightedRandomBatchSampler(
            dataset=datasets["dataset_train"],
            batch_size=batch_size,
            group_identifiers=group_identifiers,
            target_col=target_col,
        ...
        batch_sampler = ra_utils.data.datasampler_CR_patches.PatientBatchSampler(patient_ids,
                                            batch_size=batch_size,
                                            drop_last=False)
        ...
        batch_sampler = ra_utils.data.datasampler_CR_patches.WeightedPatientBatchSampler(datasets["dataset_train"],
    ...
    # grouped val loader for contrastive early-stopping (deterministic, no repeats)
    # This might make sense for contrastive losses early stopping.
    val_group_ids = ["patient_id", "score_type", "left_or_right"]
    val_batch_sampler = ra_utils.data.datasampler_CR_patches.GroupPackingBatchSampler(
        dataset=datasets["dataset_validation"],
        batch_size=batch_size,
